...
export async function up(knex: Knex): Promise<void> {
  ...
  try {
    ...
    console.error('Failed to rename table: editorspicks -> editors_picks', error);
    throw error;
  }
  ...
  try {
    ...
    console.error('Failed to drop index devices_expopushtoken_unique on devices', error);
    throw error;
  }
  ...
  try {
    ...
    console.log('Successfully renamed column: expoPushToken -> expo_push_token');
  } catch (error) {
    console.error('Failed to rename column: expoPushToken -> expo_push_token', error);
    throw error;
  }
  ...
  try {
    ...
    console.log('Successfully renamed column: isPushEnabled -> is_push_enabled');
  } catch (error) {
    console.error('Failed to rename column: isPushEnabled -> is_push_enabled', error);
    throw error;
  }
...
export async function down(knex: Knex): Promise<void> {
  ...
  try {
    ...
    console.error('Failed to rename table: editors_picks -> editorspicks', error);
    throw error;
  }
  ...
  try {
    ...
    console.log('Successfully renamed column: expo_push_token -> expoPushToken');
  } catch (error) {
    console.error('Failed to rename column: expo_push_token -> expoPushToken', error);
    throw error;
  }

  // Recreate the unique index for expoPushToken
  try {
    await knex.raw('CREATE UNIQUE INDEX devices_expopushtoken_unique ON devices(expoPushToken)');
  ...
  try {
    ...
    console.log('Successfully renamed column: is_push_enabled -> isPushEnabled');
  } catch (error) {
    console.error('Failed to rename column: is_push_enabled -> isPushEnabled', error);
    throw error;
  }
