      ...
      <table className="min-w-full bg-white border border-gray-300">
        <thead>
          <tr className="bg-gray-200">
            ...
            <th className="py-2 px-4 border-b text-center">Science and Research</th>
          ...
          {devices && devices.length > 0 ? (
            devices.map((device) => (
              <tr key={device.expo_push_token}>
                <td className="py-2 px-4 border-b text-left">{device.device_type}</td>
                ...
                <td className="py-2 px-4 border-b text-left">{device.expo_push_token}</td>
