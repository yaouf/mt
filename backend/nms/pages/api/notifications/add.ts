...
export default async function getNotification(
  ...
  try {
    ...
    await notificationQueue.add(
      "notification",
      { notificationId, time, title, body, tags, url, isUid },
      { delay, jobId: `${notificationId}_n` }
    );
    ...
    console.log("Notifications in database after adding:", notifications);
...
//     const _job = await notificationQueue.add(
//       "notification",
