...
with_node \
  ...
  --target "/Users/rachelchae/mobileapp/frontend/ios/Pods/Target Support Files/Pods-bdhapp/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake"
