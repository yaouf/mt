...
function LargeCard({ article, navigation }: CardProps) {
  ...
  const cardStyles = isDarkMode ? darkStyles : styles;
      ...
      >
        <View style={cardStyles.card}>
          ...
          <View style={cardStyles.text}>
            <Text style={cardStyles.title}>{article.headline}</Text>
            <Text style={cardStyles.subhead} numberOfLines={6} ellipsizeMode="tail">
              {article.subhead}
            </Text>
            <View style={cardStyles.bottom}>
              <View style={cardStyles.publishedSection}>
                <Text style={cardStyles.published}>
...
const darkStyles = StyleSheet.create({
  ...
  published: {
    // color here needs to be a different color
    color: varGray1,
    fontFamily: font3,
    fontSize: 14,
    fontStyle: "normal",
