...
function ArticleScreen({ article }: Article) {
  ...
  const customRenderer = {
    p: (
      ...
      return (
        <Text style={styles.text} key={passProps.key}>
          {children}
        </Text>
      );
    },
    a: (
      ...
      return (
        <Text style={styles.hyperlink} key={passProps.key}>
          {children}
        </Text>
      );
    },
        ...
        <View style={styles.container}>
          ...
          <View style={styles.articleBodyWrapper}>
            <View style={styles.articleBody}>
              {/* Renders the text from HTML to text component, uses custom styling */}
              <RenderHTML source={source} baseStyle={styles.text} />
